...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlertCircle'
        db.create_table('gpsweb_alertcircle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alert', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gpsweb.Alert'])),
            ('center_lat', self.gf('django.db.models.fields.CharField')(max_length=13)),
            ('center_long', self.gf('django.db.models.fields.CharField')(max_length=13)),
            ('radius', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('gpsweb', ['AlertCircle'])

        # Adding field 'Driver.is_active'
        db.add_column('gpsweb_driver', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Alert.geo_top_left_lat'
        db.delete_column('gpsweb_alert', 'geo_top_left_lat')

        # Deleting field 'Alert.geo_bottom_right_lat'
        db.delete_column('gpsweb_alert', 'geo_bottom_right_lat')

        # Deleting field 'Alert.geo_top_left_long'
        db.delete_column('gpsweb_alert', 'geo_top_left_long')

        # Deleting field 'Alert.geo_bottom_right_long'
        db.delete_column('gpsweb_alert', 'geo_bottom_right_long')

        # Deleting field 'Car.car_number'
        db.delete_column('gpsweb_car', 'car_number')

        # Adding field 'Car.is_active'
        db.add_column('gpsweb_car', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Car.name'
        db.alter_column('gpsweb_car', 'name', self.gf('django.db.models.fields.CharField')(max_length=7))

    def backwards(self, orm):
        # Deleting model 'AlertCircle'
        db.delete_table('gpsweb_alertcircle')

        # Deleting field 'Driver.is_active'
        db.delete_column('gpsweb_driver', 'is_active')

        # Adding field 'Alert.geo_top_left_lat'
        db.add_column('gpsweb_alert', 'geo_top_left_lat',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=13),
                      keep_default=False)

        # Adding field 'Alert.geo_bottom_right_lat'
        db.add_column('gpsweb_alert', 'geo_bottom_right_lat',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=13),
                      keep_default=False)

        # Adding field 'Alert.geo_top_left_long'
        db.add_column('gpsweb_alert', 'geo_top_left_long',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=13),
                      keep_default=False)

        # Adding field 'Alert.geo_bottom_right_long'
        db.add_column('gpsweb_alert', 'geo_bottom_right_long',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=13),
                      keep_default=False)

        # Adding field 'Car.car_number'
        db.add_column('gpsweb_car', 'car_number',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=7),
                      keep_default=False)

        # Deleting field 'Car.is_active'
        db.delete_column('gpsweb_car', 'is_active')


        # Changing field 'Car.name'
        db.alter_column('gpsweb_car', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
