...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationLog.driver'
        db.add_column('gpsweb_locationlog', 'driver',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['gpsweb.Driver']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationLog.driver'
        db.delete_column('gpsweb_locationlog', 'driver_id')
