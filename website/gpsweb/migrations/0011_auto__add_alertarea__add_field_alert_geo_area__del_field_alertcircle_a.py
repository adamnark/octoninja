...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlertArea'
        db.create_table('gpsweb_alertarea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('gpsweb', ['AlertArea'])

        # Adding field 'Alert.geo_area'
        db.add_column('gpsweb_alert', 'geo_area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gpsweb.AlertArea'], null=True),
                      keep_default=False)

        # Deleting field 'AlertCircle.alert'
        db.delete_column('gpsweb_alertcircle', 'alert_id')

        # Adding field 'AlertCircle.area'
        db.add_column('gpsweb_alertcircle', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['gpsweb.AlertArea']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AlertArea'
        db.delete_table('gpsweb_alertarea')

        # Deleting field 'Alert.geo_area'
        db.delete_column('gpsweb_alert', 'geo_area_id')

        # Adding field 'AlertCircle.alert'
        db.add_column('gpsweb_alertcircle', 'alert',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['gpsweb.Alert']),
                      keep_default=False)

        # Deleting field 'AlertCircle.area'
        db.delete_column('gpsweb_alertcircle', 'area_id')
    ...
    models = {
        ...
        'gpsweb.alert': {
            ...
            'geo_area': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gpsweb.AlertArea']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'gpsweb.fuelconsumption': {
            'Meta': {'object_name': 'FuelConsumption'},
            'car': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gpsweb.Car']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
