...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrimaryDriver'
        db.create_table('gpsweb_primarydriver', (
        ...
        db.send_create_signal('gpsweb', ['PrimaryDriver'])


    def backwards(self, orm):
        # Deleting model 'PrimaryDriver'
        db.delete_table('gpsweb_primarydriver')
