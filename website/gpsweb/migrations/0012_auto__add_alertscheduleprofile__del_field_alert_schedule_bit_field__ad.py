...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlertScheduleProfile'
        db.create_table('gpsweb_alertscheduleprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('schedule_bit_field', self.gf('django.db.models.fields.CharField')(max_length=168)),
        ))
        db.send_create_signal('gpsweb', ['AlertScheduleProfile'])

        # Deleting field 'Alert.schedule_bit_field'
        db.delete_column('gpsweb_alert', 'schedule_bit_field')

        # Adding field 'Alert.schedule_profile'
        db.add_column('gpsweb_alert', 'schedule_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gpsweb.AlertScheduleProfile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AlertScheduleProfile'
        db.delete_table('gpsweb_alertscheduleprofile')

        # Adding field 'Alert.schedule_bit_field'
        db.add_column('gpsweb_alert', 'schedule_bit_field',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=168),
                      keep_default=False)

        # Deleting field 'Alert.schedule_profile'
        db.delete_column('gpsweb_alert', 'schedule_profile_id')
    ...
    models = {
        ...
        'gpsweb.alert': {
            ...
            'schedule_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gpsweb.AlertScheduleProfile']", 'null': 'True'}),
