...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.owner'
        db.add_column('gpsweb_person', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Person.is_primary'
        db.add_column('gpsweb_person', 'is_primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.owner'
        db.delete_column('gpsweb_person', 'owner_id')

        # Deleting field 'Person.is_primary'
        db.delete_column('gpsweb_person', 'is_primary')
