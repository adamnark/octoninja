...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('gpsweb_fuelconsumption')

        # Adding model 'FuelConsumptionLog'
        db.create_table('gpsweb_fuelconsumptionlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('car', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gpsweb.Car'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('liters', self.gf('django.db.models.fields.IntegerField')()),
            ('price_per_liter', self.gf('django.db.models.fields.FloatField')()),
            ('station_id', self.gf('django.db.models.fields.IntegerField')()),
            ('kilometrage', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('gpsweb', ['FuelConsumptionLog'])


    def backwards(self, orm):
        # Adding model 'FuelConsumption'
        db.create_table('gpsweb_fuelconsumption', (
            ('month', self.gf('django.db.models.fields.DateTimeField')()),
            ('car', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gpsweb.Car'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('liters', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('gpsweb', ['FuelConsumption'])

        # Deleting model 'FuelConsumptionLog'
        db.delete_table('gpsweb_fuelconsumptionlog')
