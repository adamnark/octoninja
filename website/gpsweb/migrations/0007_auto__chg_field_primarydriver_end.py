...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PrimaryDriver.end'
        db.alter_column('gpsweb_primarydriver', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PrimaryDriver.end'
        raise RuntimeError("Cannot reverse this migration. 'PrimaryDriver.end' and its values cannot be restored.")
