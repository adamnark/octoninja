...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlertFormat'
        db.create_table('gpsweb_alertformat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alert_type', self.gf('django.db.models.fields.IntegerField')(max_length=1)),
            ('format_sms', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('format_email', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal('gpsweb', ['AlertFormat'])


    def backwards(self, orm):
        # Deleting model 'AlertFormat'
        db.delete_table('gpsweb_alertformat')
